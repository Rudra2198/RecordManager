...
2. Compile the program by typing the following command in the terminal:
   ...
   ```bash
   make
This will compile all the necessary files and create the executable.
...
Copy code
make run
This will execute the default test files for the Record Manager.

Clean up the project by typing the following command:

bash
Copy code
make clean
This will remove any compiled object files, executables, and log files generated during the build process.
