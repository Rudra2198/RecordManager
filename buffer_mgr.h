...
extern pthread_mutex_t buffer_pool_init_mutex;
extern pthread_cond_t buffer_pool_cond;
extern int active_threads;
extern bool buffer_pool_shutting_down;
...
// Replacement Strategies Functions
